...
function decode( buffer, offset, length ) {
  ...
  var context = {
    ...
    objectCount: int64.readUIntBE( buffer, trailerOffset + 8 ),
    rootObject: int64.readUIntBE( buffer, trailerOffset + 16 ),
    offsetTableOffset: int64.readUIntBE( buffer, trailerOffset + 24 ),
    // Offset Table
    offsetTable: null,
  }
