...
class Plist {
  ...
  /** @type {String} Binary format signature */
  static SIGNATURE_BINARY = 'bplist'
  /** @type {String} XML format signature */
  static SIGNATURE_XML = '<?xml '
  /** @type {String} JSON format signature */
  static SIGNATURE_JSON = '{'
  /** @type {Number} Propertly list epoch */
  static EPOCH = 978307200000
  /** @enum {String} XML doctype versions */
  static DOCTYPE = {
